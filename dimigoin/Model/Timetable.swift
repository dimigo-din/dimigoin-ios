...
class TimeTableAPI: ObservableObject {
    var data: [[TimeTable]] = [[TimeTable(data: [["통합사회", "음악", "영어", "한국사", "컴그", "컴그", "수학"],
                                                 ["상경", "사회", "국어", "과학", "체육"],
                                                 ["영어", "상경", "음악", "한국사", "과학", "수학"],
                                                 ["컴그", "컴그", "상경", "사회", "체육", "국어"],
                               ...
                               [TimeTable(data: [["광콘", "광콘", "회계", "문학", "중국어", "정처", "정처"],
                                ...
                                [TimeTable(data:[["비즈니스", "고전", "공수", "전자상거래", "전자상거래", "확통", "앱콘"],
                                                 ["회계", "확통", "앱콘", "영어", "마케팅"],
                                                 ["마케팅", "비즈니스", "고전", "진로", "회계", "앱콘"],
                                                 ["영어", "고전", "공수", "앱콘", "애콘", "애콘"],
                                                 ["애콘", "애콘", "비즈니스", "전자상거래", "마케팅", "확통", "회계"]]),
    ...
    func getTimeTable(grade: Int, klass: Int) -> TimeTable {
